...
- **Branch Naming**: Follow the project's branch naming convention (typically `feature/[ticket-id]-frontend` or similar pattern as specified in `frontend-standards.mdc`)
