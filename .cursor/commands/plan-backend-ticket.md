...
- **Branch Naming**: Follow the project's branch naming convention (typically `feature/[ticket-id]-backend` or similar pattern as specified in `backend-standards.mdc`)
